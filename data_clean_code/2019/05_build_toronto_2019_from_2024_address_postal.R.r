...
# FILE PATHS
# ==========================================
file_2019 <- "~/Desktop/raw data/annual-energy-consumption-data-2019.xlsx"
...
GAS_TO_EKWH  <- 10.68
GAS_TO_CO2E  <- 1.921
ELEC_TO_CO2E <- 0.029   # Ontario 2019, team's yearly series
...
# ==========================================
# READ 2019 RAW FILE
# 2019 is a single-sheet wide table with metadata rows on top
# ==========================================
raw_2019 <- read_excel(
  file_2019,
  sheet = 1,
...
# ==========================================
# CLEAN 2019 AND MATCH TO 2024 BY ADDRESS + POSTAL
# ==========================================
clean_2019 <- raw_2019 %>%
  mutate(
...
write.csv(
  final_table_2019,
  "~/Desktop/cleaned data/toronto_2019_property_energy_summary_from_2024_address_postal_with_EUI_GHG.csv",
  row.names = FALSE,
  na = ""
)

write_xlsx(
  list(Summary = final_table_2019),
  "~/Desktop/cleaned data/toronto_2019_property_energy_summary_from_2024_address_postal_with_EUI_GHG.xlsx"
)

# ==========================================
# QUICK CHECKS
# ==========================================
cat("Number of matched 2019 properties:", nrow(final_table_2019), "\n\n")

cat("Preview:\n")
print(head(final_table_2019, 10))

cat("\nSummary of EUI:\n")
print(summary(final_table_2019$EUI_ekWh_sqft))

cat("\nSummary of GHG intensity:\n")
print(summary(final_table_2019$GHG_Intensity_kg_sqft))