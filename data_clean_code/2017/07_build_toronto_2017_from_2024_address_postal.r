...
# FILE PATHS
# ==========================================
file_2017 <- "~/Desktop/raw data/annual-energy-consumption-data-2017.xlsx"
...
GAS_TO_EKWH  <- 10.68
GAS_TO_CO2E  <- 1.921
ELEC_TO_CO2E <- 0.019   # Ontario 2017 consumption intensity
...
# ==========================================
# CLEAN 2017 AND MATCH TO 2024 BY ADDRESS + POSTAL
# ==========================================
clean_2017 <- raw_2017 %>%
  mutate(
...
write.csv(
  final_table_2017,
  "~/Desktop/cleaned data/toronto_2017_property_energy_summary_from_2024_address_postal_with_EUI_GHG.csv",
  row.names = FALSE,
  na = ""
)

write_xlsx(
  list(Summary = final_table_2017),
  "~/Desktop/cleaned data/toronto_2017_property_energy_summary_from_2024_address_postal_with_EUI_GHG.xlsx"
)

# ==========================================
# QUICK CHECKS
# ==========================================
cat("Number of matched 2017 properties:", nrow(final_table_2017), "\n\n")

cat("Preview:\n")
print(head(final_table_2017, 10))

cat("\nSummary of EUI:\n")
print(summary(final_table_2017$EUI_ekWh_sqft))

cat("\nSummary of GHG intensity:\n")
print(summary(final_table_2017$GHG_Intensity_kg_sqft))